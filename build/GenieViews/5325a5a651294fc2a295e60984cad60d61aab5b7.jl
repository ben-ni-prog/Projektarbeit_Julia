# Genie_15185880786215616157 

function func_2f5d22a6629e5550537a68d55e90b3ea667baa92(;
                ...
                q__tab__panel(name = "home", htmlsourceindent = "3") do
                    [
                        Genie.Renderer.Html.div(
                            class = "bg-white shadow-0 st-col col",
                            style = "padding: 10px; border: 2px solid light-blue-10",
                            htmlsourceindent = "4",
                        ) do
                            [
                                ...
                                Genie.Renderer.Html.p(
                                    ...
                                    [
                                        """This website gives an insight and interface to the database containing the tasks of a cantine in need of getting completed.""";
                                    ]
                                end
                                Genie.Renderer.Html.p(
                                    class = "text-black",
                                    ...
                                    [
                                        """Below you can get insight into the most urgent tasks.""";
                                    ]
                                end
                                Genie.Renderer.Html.p(
                                    class = "text-black",
                                ...
                                Genie.Renderer.Html.p(
                                    ...
                                    [
                                        """To mark tasks as completed or delete them from the list, please go to "Edit Tasks".""";
                                    ]
                                end
                            ]
                        end
