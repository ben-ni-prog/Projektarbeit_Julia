# Genie_11409515479402092216 

function func_686dce852aa2a01173cd5073819755e66882e88b(;
                ...
                q__tab__panel(name = "home", htmlsourceindent = "3") do
                    [
                        Genie.Renderer.Html.div(
                            class = "bg-white shadow-5 st-col col",
                            style = "padding: 10px; border: 2px solid text-primary",
                            htmlsourceindent = "4",
                        ) do
                            [
