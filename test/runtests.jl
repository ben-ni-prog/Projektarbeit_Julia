...
# !!! Main.UserApp is configured as an alias for Main.DatabaseInterface and you might encounter it in some tests
using Main.DatabaseInterface, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "DatabaseInterface tests" begin
  @includetests ARGS
end
